...
public class WatersController {
    private WatersService service;
    private ApplicationContext applicationContext;

    @PostMapping
    @ApiOperation(value = "添加", notes = "根据实体对象添加数据")
    public Waters save(@RequestBody Waters entity) {
    ...
    public Waters updateById(@RequestBody Waters entity) {
        applicationContext.publishEvent(
                new CleanCacheEvent(this, ConnectionParameterUtil.getTableName(entity)));
    ...
    public Waters get(@PathVariable("id") Integer id) {
