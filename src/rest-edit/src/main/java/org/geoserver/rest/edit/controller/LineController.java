...
public class LineController {
    ...
    public Line save(@RequestBody Line entity) {
    ...
    public Line updateById(@RequestBody Line entity) {
        applicationContext.publishEvent(
                new CleanCacheEvent(this, ConnectionParameterUtil.getTableName(entity)));
    ...
    public Line get(@PathVariable("id") Integer id) {
