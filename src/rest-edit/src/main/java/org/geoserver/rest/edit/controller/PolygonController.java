...
public class PolygonController {
    ...
    public Polygon save(@RequestBody Polygon entity) {
    ...
    public Polygon updateById(@RequestBody Polygon entity) {
        applicationContext.publishEvent(
                new CleanCacheEvent(this, ConnectionParameterUtil.getTableName(entity)));
    ...
    public Polygon get(@PathVariable("id") Integer id) {
