...
public class BuildController {
    ...
    public Build save(@RequestBody Build entity) {
    ...
    public Build updateById(@RequestBody Build entity) {
        applicationContext.publishEvent(
                new CleanCacheEvent(this, ConnectionParameterUtil.getTableName(entity)));
    ...
    public Build get(@PathVariable("id") Integer id) {
