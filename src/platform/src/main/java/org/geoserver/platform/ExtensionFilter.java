 ...
 *
 * <p>可插入的扩展，可用于在扩展点实现之前筛选出它 由{@link GeoServerExtensions#extensions(Class)}返回
 *
...
public interface ExtensionFilter {
     ...
     *
     * <p>如果任何注册的{@link ExtensionFilter}返回{@code true}，则有问题的bean将是 从{@link
     * GeoServerExtensions（Class）}返回的列表中删除
     *
