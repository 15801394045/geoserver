...
/**
 * Produces and maps for an specific output format. 为特定输出格式生成和映射。
 *
...
public interface GetMapOutputFormat {
     ...
     * contains enough information for doing such a process. 要求此映射生成器为传递的{@linkPlain
     * WMSMapContext}创建映射图像，其中包含执行此进程所需的足够信息。
     *
    ...
    /**
     * Returns the mime type generated by the format 返回由格式生成的mime类型 String
     *
     * @return
     */
    String getMimeType();
    ...
    /**
     * Returns the capabilities for the specified format 返回指定格式的功能
     *
     * @param format format
